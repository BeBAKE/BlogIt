...
const PublishedBlog = ()=>{
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-start items-center overflow-y-scroll" onScroll={scrolling}>
...

      {
        ...
        (
          isEmpty
          ?
          <NoBlogs label={"Published blogs will be shown here"}/>
          :
          <div className="">
          {
