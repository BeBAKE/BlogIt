...
// right = -[(half of div - half of more)]px - to center the pop up menu
  return (
    <div 
    id="BmFloatingMenu"
    className={`${pBFloatingMenu ? "visible":"invisible"} w-40 h-20 absolute top-6 right-1 md:right-[-4.375rem] z-10 flex flex-col items-center gap-0 justify-center md:mx-0`}>
